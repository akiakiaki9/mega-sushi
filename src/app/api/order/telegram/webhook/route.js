...
const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://megasushi.uz';
...
✈️ <a href="${INFO.telegramBot}">Telegram</a>
...
• Минимальный заказ — <b>50 000 сум</b>
...
const mainKeyboard = {
    inline_keyboard: [
        ...
        [
            ...
            { text: '✈️ Telegram', url: INFO.telegramBot },
        ],
    ],
};
...
export async function POST(request) {
    try {
        // Проверка секретного заголовка (защита от подделок)
        ...
        // Telegram ждёт 200 даже при ошибке, чтобы не спамил retry
        return NextResponse.json({ ok: true });
    }
}